...
# settings.py (direct values — not recommended for production)
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'tomikalshg',
        'USER': 'codestar',
        'PASSWORD': '1Dquelah*1',            # use your actual password
        'HOST': '162.220.14.16',           # DB host or IP (use 'db.server.ip' or hostname)
        'PORT': '3306',
        'OPTIONS': {
            'init_command': "SET sql_mode='STRICT_TRANS_TABLES'",
            'charset': 'utf8mb4',
        },
        # optional: keep DB connections open for performance
        # 'CONN_MAX_AGE': 600,
...
TIME_ZONE = 'Africa/Nairobi'  # Updated to Kenya's timezone
...
# Optional: Adjust JWT settings like token lifetime, etc.
